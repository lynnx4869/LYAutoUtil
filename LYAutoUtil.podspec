#
#  Be sure to run `pod spec lint LYAutoUtil.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/lynnx4869/LYAutoUtil.git", :tag => "#{s.version}" }
